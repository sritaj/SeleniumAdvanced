...
public class MailConfiguration {
	...
	public static void sendReport() {
		...
		try {
			...
			messageBodyPart1.setText("Hola, We just got a new build to test" + "\n\nWe have run a quick test to verify the Application is smooth and up. Please check the reports.");
